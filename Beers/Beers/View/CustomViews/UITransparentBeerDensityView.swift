//
//  UITransparentBeerDensityView.swift
//  Beers
//
...
@IBDesignable
class UITransparentBeerDensityView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        // first
        let firstEmptyProgressPath = UIBezierPath(arcCenter: center, radius: radius, startAngle: -CGFloat.pi/2.0, endAngle: 0.0, clockwise: true)
        
        firstEmptyProgressPath.usesEvenOddFillRule = true
        
        context?.addPath(firstEmptyProgressPath.cgPath)
        ...
        // second
        let secondEmptyProgressPath = UIBezierPath(arcCenter: center, radius: radius, startAngle: 0.0, endAngle: CGFloat.pi/2.0, clockwise: true)
        
        secondEmptyProgressPath.usesEvenOddFillRule = true
        
        context?.addPath(secondEmptyProgressPath.cgPath)
        ...
        //third
        let thirdEmptyProgressPath = UIBezierPath(arcCenter: center, radius: radius, startAngle: CGFloat.pi/2.0, endAngle: CGFloat.pi, clockwise: true)
        
        thirdEmptyProgressPath.usesEvenOddFillRule = true
        
        context?.addPath(thirdEmptyProgressPath.cgPath)
        ...
        //forth
        let forthEmptyProgressPath = UIBezierPath(arcCenter: center, radius: radius, startAngle: CGFloat.pi, endAngle: -CGFloat.pi/2.0, clockwise: true)
        
        forthEmptyProgressPath.usesEvenOddFillRule = true
        
        context?.addPath(forthEmptyProgressPath.cgPath)
        ...
        let filledPath = UIBezierPath(arcCenter: center, radius: radius, startAngle: startAngle, endAngle: endAngle, clockwise: true)
